                ...
                <div class="col-xl-4 col-md-6 col-sm-8">
                    <div class="login-area">
                        <div class="login-header-wrapper text-center">
                           <a href="{{url('https://icashers.com/')}}"> <img class="logo" src="{{ get_image(config('constants.logoIcon.path') .'/logo.png') }}" alt="image"> </a>
                        ...
                        <form action="{{ route('user.login') }}" method="POST" class="login-form" id="recaptchaForm">
                            ...
                            <div class="login-inner-block">
                                <div class="frm-grp">
                                    ...
                                    <input type="text" name="username" @keyup="checkPassword"  value="{{ old('username') }}" placeholder="@lang('Enter username or email')">
                                </div>
                                <div class="frm-grp">
                            ...
                            <div class="btn-area text-center">
                                <button type="submit"  class="submit-btn">@lang('Sign In')</button>
                            </div>
                            <br>

                            <div class="d-flex mt-3 justify-content-between">
                                <a href="{{ route('user.password.request') }}" class="forget-pass">@lang('Forgot password?')</a>
