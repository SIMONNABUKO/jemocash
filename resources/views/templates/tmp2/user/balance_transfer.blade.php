            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title font-weight-normal">@lang('Transfer Money To Other Users')</h4>
                    </div>

                    <div class="col-md-12 text-center">
                        <div class="alert alert-danger" role="alert">
                            <strong>@lang('Transaction cost is')  {{__($general->bal_trans_per_charge)}}
                                % @lang('of your total amount to transfer.')</strong>
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>@lang('Username / Email for Recipient (Must be a member of this website)') <span class="text-danger">*</span></label>
                                 ...
                                 <div class="form-group col-md-12">
                                     ...
                                     <label for="InputMail">@lang('Enter Amount in USD') <span
                                                 v-if="wallet_name">  </span> <span class="requred">*</span></label>
                                     <input type="text" class="form-control" id="InputMail" v-model="newdata.amount"
                                            name="amount" placeholder="@lang('Amount in') {{__($general->cur_text)}}" required>
                                     <small v-if="parseInt(balance) < parseInt(newdata.amount)"
                                            style="color: red">@lang('Insufficient Account Balance!')</small>
